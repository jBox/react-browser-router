...
describe("ReactBrowserRouter", function () {
    describe("initHistory", function () {
        it("initHistory should be function", function () {
            expect(typeof _index.initHistory === "undefined" ? "undefined" : _typeof(_index.initHistory)).to.equal("function");
        });
        it("init history after creating routers should throw exception", function () {
            ...
            expect(_index.initHistory).to.throw(Error);
        });
    });
});
...
var global = window;
var BROWSER_HISTORY = "__BROWSER_HISTORY__";
 ...
 */
var initHistory = exports.initHistory = function initHistory(options) {
    if (global[BROWSER_HISTORY]) {
        throw new Error("Initiating history should be done before any <Router>s called.");
    }

    global[BROWSER_HISTORY] = (0, _createBrowserHistory2.default)(options);
...
var ReactBrowserRouter = function (_Component) {
    ...
    function ReactBrowserRouter() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReactBrowserRouter.__proto__ || Object.getPrototypeOf(ReactBrowserRouter)).call.apply(_ref, [this].concat(args))), _this), _this.history = createHistory(), _temp), _possibleConstructorReturn(_this, _ret);
    }
...
module.exports = __webpack_require__("./index.d.js");
